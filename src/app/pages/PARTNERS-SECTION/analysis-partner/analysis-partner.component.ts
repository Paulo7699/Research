...
@Component({
  selector: 'app-analysis-partner',
  templateUrl: './analysis-partner.component.html',
  styleUrls: ['./analysis-partner.component.scss']
})
export class AnalysisPartnerComponent implements OnInit {
  dataDisplayed : any[] = [];
